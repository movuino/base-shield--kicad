...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 46.0, 96.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 564.0, 324.199707000000217, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 467.666666666666686, 324.199707000000217, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 661.0, 324.199707000000217, 83.0, 22.0 ],
					"text" : "loadmess 150"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 274.333333333333371, 347.0, 70.0, 22.0 ],
					"text" : "loadmess 2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 661.0, 385.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numpoints" : 83,
					"outlettype" : [ "" ],
					"patching_rect" : [ 81.0, 477.800292999999783, 599.0, 306.0 ],
					"presentation" : 1,
					"presentation_rect" : [ 65.499915999999999, 417.36605800000001, 1035.0, 234.0 ],
					"subplots" : [ 						{
							"color" : [ 0.286274522542953, 0.317647069692612, 0.815686285495758, 1.0 ],
							"thickness" : 5.400000095367432,
							"point_style" : "none",
							"line_style" : "curve",
							"number_style" : "none",
							"filter" : "none",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 274.333333333333371, 376.800292999999783, 33.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 177.666666666666686, 304.5, 100.0, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 371.0, 385.0, 100.0, 23.0 ]
				}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "bang", "int" ],
									"patching_rect" : [ 1691.0, 109.0, 29.5, 22.0 ],
									"text" : "t b i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1604.0, 159.0, 117.0, 22.0 ],
									"text" : "pack i i"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1691.0, 66.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1604.0, 66.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1852.0, 324.099976000000026, 91.0, 22.0 ],
									"text" : "numpoints $1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 1852.0, 117.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1852.0, 61.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1638.0, 282.099976000000026, 100.0, 22.0 ],
									"text" : "loadmess 0 5000"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 66.0, 345.0, 49.0, 22.0 ],
									"text" : "r purple"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1604.0, 324.099976000000026, 105.0, 22.0 ],
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1861.5, 228.0, 997.5, 228.0 ],
									"order" : 1,
									"source" : [ "obj-12", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1861.5, 228.0, 631.5, 228.0 ],
									"order" : 2,
									"source" : [ "obj-12", 0 ]
								}
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 1861.5, 227.0, 324.0, 227.0 ],
									"order" : 3,
									"source" : [ "obj-12", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-3", 0 ],
									"midpoints" : [ 1861.5, 570.0, 227.0, 570.0 ],
									"order" : 2,
									"source" : [ "obj-14", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-4", 0 ],
									"midpoints" : [ 1861.5, 571.0, 534.5, 571.0 ],
									"order" : 1,
									"source" : [ "obj-14", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-5", 0 ],
									"midpoints" : [ 1861.5, 570.0, 900.5, 570.0 ],
									"order" : 0,
									"source" : [ "obj-14", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-20", 0 ],
									"midpoints" : [ 1700.5, 152.0, 1613.5, 152.0 ],
									"source" : [ "obj-21", 0 ]
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-238", 0 ],
									"midpoints" : [ 1647.5, 318.0, 1613.5, 318.0 ],
									"source" : [ "obj-9", 0 ]
								}
...
,
					"patching_rect" : [ 81.0, 438.600586000000021, 599.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 251.0, 233.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 185.5, 233.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 120.0, 233.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "float", "float", "float" ],
					"patching_rect" : [ 120.0, 195.0, 150.0, 22.0 ],
					"text" : "unpack f f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 81.0, 148.0, 89.0, 22.0 ],
					"text" : "route /pressure"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 185.0, 96.0, 262.0, 22.0 ],
					"text" : "/pressure 522.24"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 81.0, 40.0, 97.0, 22.0 ],
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-3", 1 ],
					"midpoints" : [ 90.5, 77.0, 437.5, 77.0 ],
					"order" : 0,
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 90.5, 180.0, 129.5, 180.0 ],
					"order" : 0,
					"source" : [ "obj-4", 0 ]
				}
